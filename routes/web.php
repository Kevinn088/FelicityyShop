...
Route::middleware(['auth', 'user-access:pembeli'])->group(function () {
    ...
    // ✅ Edit dan update alamat
    Route::get('/customer/alamat/edit/{id}', [AlamatCustomerController::class, 'edit_checkout'])->name('customer.alamat_edit');
    Route::put('/customer/alamat/update/{id}', [AlamatCustomerController::class, 'update_checkout'])->name('customer.alamat_update');
