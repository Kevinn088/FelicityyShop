    ...
    <div class="banner-left floatleft">
        ...
        <div class="slider-banner">
            <div class="single-banner banner-1">
                <a class="banner-thumb" href="/product"><img src="/annprint/banner-1.png"
                        alt="" /></a>
            </div>
            <div class="single-banner banner-2">
                <a class="banner-thumb" href="#"><img src="/annprint/banner-2.png"
                        alt="" /></a>
            </div>
        </div>
        <!-- Slider-banner end -->
        ...
        <div class="slider-area">
            <div class="bend niceties preview-2">
                <div id="ensign-nivoslider" class="slides">
                    <img src="/annprint/slider-12.jpg" alt="" title="#slider-direction-1" />
                    <img src="/annprint/slider-13.jpeg" alt="" title="#slider-direction-2" />
                    <img src="/annprint/slider-14.png" alt="" title="#slider-direction-3" />
                </div>
                <!-- direction 1 -->
                        ...
                        <div class="title-container s-tb-c title-compress">
                            <div class="layer-1">
                                <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                                    <h2 class="slider-title3 text-uppercase mb-0" style="color:white"> </h2>
                                </div>
                                <div class="wow fadeIn" data-wow-duration="1.5s" data-wow-delay="1.5s">
                                    <h2 class="slider-title1 text-uppercase mb-0" style="color:white"> </h2>
                                </div>
                                <div class="wow fadeIn" data-wow-duration="2s" data-wow-delay="2.5s">
                                    <h3 class="slider-title2 text-uppercase" style="color:white"><Fieldset> </Fieldset>
                                    </h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="title-container s-tb-c title-compress">
                            <div class="layer-1">
                                <div class="wow fadeInUpBig" data-wow-duration="1.5s" data-wow-delay="0.5s">
                                    <h2 class="slider-title1 text-uppercase"></h2>
                                </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title text-center">
                    <h2 class="title-border">Produk Terlaris</h2>
                </div>
            ...
            <div class="discount-product-slider dots-bottom-right">
                ...
                <div class="col-lg-12">
                    <div class="discount-product">
                        <img src="/annprint/banner-5.png" alt="" />
                    </div>
                </div>
            </div>
        </div>
