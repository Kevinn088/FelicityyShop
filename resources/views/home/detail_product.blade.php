                    ...
                    <div class="single-product clearfix">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-description">
                               ...
                               <div>
                            <div class="mb-3"> {{-- Memberi jarak ke bawah --}}
                                <strong class="d-block mb-1">1 pcs</strong> {{-- Memberi jarak ke harga --}}
                                ...
                                @else
                                    <span>{{ rupiah($detail->harga_produk1) }}</span>
                                @endif
                            </div>
                            </div>
                            <!-- color start -->
                            <div class="color-filter single-pro-color mb-20 clearfix">
                                <ul>
                                    ...
                                    <li> : </li>
                                    <li>&nbsp Seluruh Warna Pada Gambar Tersedia</li>
                                </ul>
                            </div>
                            <!-- color end -->
                            <!-- Size start -->
