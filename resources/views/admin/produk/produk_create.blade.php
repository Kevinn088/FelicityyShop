                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('produk.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label for="validationCustom01" class="form-label">Harga 1 pcs</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div id="warna-wrapper">
                                        <div class="input-group mb-2">
                                            ...
                                            <button type="button" class="btn btn-outline-secondary tambah-warna">+</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3">
...
@section('js')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            document.querySelector('#warna-wrapper').addEventListener('click', function (e) {
                if (e.target.classList.contains('tambah-warna')) {
                    ...
                    `;
                    document.querySelector('#warna-wrapper').appendChild(wrapper);
                } else if (e.target.classList.contains('hapus-warna')) {
