                 ...
                 <div class="col-xl-12">
                     <div class="card bg-warning text-white shadow">
                        <div class="card-body text-center">
                                <h5 class="mb-3">Akses Panel Persediaan Barang</h5>
                                <p class="mb-4">Klik tombol di bawah untuk mengelola stok barang di sistem persediaan.</p>
                                <a href="http://localhost:8001" target="_blank" class="btn btn-light">
                                    🔐 Buka Panel Persediaan
                                </a>
                        </div>
                    </div>
                </div>
